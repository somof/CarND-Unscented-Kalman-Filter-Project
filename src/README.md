センサフュージョン≒カルマンフィルタとしたときの歴史

トルバルド・ティエレとピーター・スワーリングによって開発
NASAを訪れたルドルフ・カルマンがロケットの軌道推定に有用だと提唱
アポロ計画に採用されたことで、後に広まった　（１９６０ー１９７０年）
...
アーリーフュージョンとは？
歴史から考えると
「センサフュージョン」は、もともと、アーリーフュージョン（RAWDATAフュージョン）

レイトフュージョンの方が特殊といえる　（Ｗｉｋｉｐｅｄｉａの定義に当てはまらない）
